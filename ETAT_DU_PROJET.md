...
- Le sous-titre « Installer l’application et conserver sa notice » a été retiré de la page d’accueil. Le message « L’application est accessible en ligne tant qu’elle n’est pas installée en cliquant sur “Ouvrir Réseau PERT”. » est désormais affiché immédiatement, puis remplacé seulement si un état d’installation plus précis est détecté. Cette nouvelle formulation est locale et n’est pas encore publiée.
