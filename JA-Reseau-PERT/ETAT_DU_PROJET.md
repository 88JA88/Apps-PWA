...
- Le sous-titre de la page d’accueil a été supprimé et le message visible dès l’ouverture précise maintenant que l’application reste accessible en ligne en cliquant sur « Ouvrir Réseau PERT » tant qu’elle n’est pas installée. Cette formulation est locale et n’est pas encore publiée.
